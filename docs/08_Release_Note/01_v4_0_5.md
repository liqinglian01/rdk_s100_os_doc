...
### 2.3 ACore外设
#### 2.3.1 RTC
- 新增外部RTC读写时间功能，详细信息可参考《5.2.4 RDK S100驱动开发指南 - RTC调试指南》。
...
- 支持MCU子板上的IMU；
- 新增ICU GPIO中断功能，具体使用方法可参考《5.5.1 S100 MCU开发指南 - ICU使用指南》。
- MCU新增透传外设支持，具体使用方法可参考《5.5.1 S100 MCU开发指南 - IPC使用指南 - 应用Sample》：
  - 支持透传SPI；
  - 支持透传I2C。
...
### 2.8 vdsp
- 镜像集成vdsp固件，支持ipc sample以及算子的sample用例。具体描述参考《5.7 VDSP开发指南》
