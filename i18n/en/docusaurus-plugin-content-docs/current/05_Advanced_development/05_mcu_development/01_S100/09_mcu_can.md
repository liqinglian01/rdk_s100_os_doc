...
Acore cannot directly operate CAN peripherals and must rely on the IPC module to relay data. For the mapping relationship between Acore and peripheral channels, please refer to the "IPC Usage" section in the [MCU IPC Usage Guide](../../../05_Advanced_development/05_mcu_development/01_S100/08_mcu_ipc.md).
