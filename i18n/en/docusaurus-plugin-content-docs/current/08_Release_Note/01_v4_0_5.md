...
#### 2.3.1 RTC
- Added functionality for reading/writing time to an external RTC. For details, refer to *5.2.4 RDK S100 Driver Development Guide - RTC Debugging Guide*.
...
- Added ICU GPIO interrupt functionality. For usage details, refer to *5.5.1 S100 MCU Development Guide - ICU Usage Guide*.
- MCU added support for transparent transmission peripherals. For usage details, refer to *5.5.1 S100 MCU Development Guide - IPC Usage Guide - Application Sample*:
...
### 2.8 vdsp
- Integrated vdsp firmware into the image, supporting ipc sample and operator sample use cases. For details, refer to *5.7 VDSP Development Guide*.
