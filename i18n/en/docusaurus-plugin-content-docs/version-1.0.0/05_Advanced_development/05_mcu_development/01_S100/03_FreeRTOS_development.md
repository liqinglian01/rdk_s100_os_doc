...
Communication between the MCU and Acore/HSM relies on IPC. For details about interrupts used by the IPC system service, refer to the section: [IPC Introduction](../../../05_Advanced_development/05_mcu_development/01_S100/08_mcu_ipc.md).  
