...
For detailed code implementation, please refer to the section [Inference with USB Camera](../rdk_s/04_rdk_s100_algorithm_application_doc/01_pydev_dnn_demo/usb_camera).  
