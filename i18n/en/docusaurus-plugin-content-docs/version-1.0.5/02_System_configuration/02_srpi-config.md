...
- **Update Miniboot**
  ...
  If you need to upgrade Miniboot-related partitions, you can perform operations in this option. For the specific upgrade principle and partitions involved in the upgrade, please refer to: [Miniboot Upgrade](../05_Advanced_development/02_linux_development/06_OTA/02_ota_miniboot.md).
