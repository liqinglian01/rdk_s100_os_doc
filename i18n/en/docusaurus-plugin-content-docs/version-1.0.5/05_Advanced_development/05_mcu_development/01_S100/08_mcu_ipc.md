...
This section focuses on usage instructions related to the MCU side. For more details on IPC principles and usage, please refer to the [IPC Module Introduction](../../../05_Advanced_development/02_linux_development/04_driver_development_s100/06_driver_ipc.md) section.
...
:::tip
- For usage instructions on the Acore side, refer to the [IPC Module Introduction](../../../05_Advanced_development/02_linux_development/04_driver_development_s100/06_driver_ipc.md) section.
