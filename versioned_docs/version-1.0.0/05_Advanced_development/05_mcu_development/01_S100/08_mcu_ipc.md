...
此章节着重说明MCU侧的相关使用说明，更多的IPC的原理和使用可以查阅 [IPC模块介绍](../../../05_Advanced_development/02_linux_development/04_driver_development_s100/06_driver_ipc.md) 章节。
...
:::tip
配套的Acore侧应用见[IPC模块介绍](../../../05_Advanced_development/02_linux_development/04_driver_development_s100/06_driver_ipc.md#IPC_APP) 章节。
