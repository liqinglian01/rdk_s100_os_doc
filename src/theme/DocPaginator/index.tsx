...
const getCustomTitle = (permalink: string, locale: string): string | null => {
  const rules = {
    en: [
      ...
      { pattern: /^\/rdk_s100_algorithm_application_doc$/, title: '4. Algorithms' },
      ...
      { pattern: /^\/rdk_doc\/en\/rdk_s\/Basic_Application$/, title: '3. Basic Application Development' },
      { pattern: /^\/rdk_doc\/en\/rdk_s\/rdk_s100_robot_development_doc$/, title: '5. Robotics Application Development' },
      ...
      { pattern: /^\/rdk_doc\/en\/rdk_s100_robot_development_doc$/, title: '5. Robotics Application' },
      { pattern: /^\/rdk_doc\/en\/rdk_s100_robot_development_doc\/boxs\/generate\/hobot_xlm$/, title: 'DeepSeek large language model' },
    ...
    //   { pattern: /\/rdk_s100_algorithm_application_doc/, title: '4. 算法应用' },
    // ]
  };
